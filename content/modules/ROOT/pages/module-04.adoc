...
+
After saving, you will be taken to the *Details* tab for the new project. **Verify** that the *Status* for your `Apache playbooks` project is green and reads **Success**.

. **Review the sync output.**
+
**Click** on the **Success** status text to review the output of the sync job. This will show you the details of the Git clone process.
