...
image::templates-view-example-templates.png[Job Templates list view in automation controller, opts="border"]
...
+
image:validate-survey.png[Customized Apache welcome page, opts="border"]
...
image::badge-qr-code.png[QR code for Ansible Forum badge, opts="border"]
