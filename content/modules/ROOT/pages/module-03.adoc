...
image::../assets/images/Oct-16-2024_at_02.39.15-image.png[Inventories list view in automation controller, opts="border"]
...
image::../assets/images/Oct-16-2024_at_02.39.47-image.png[Creating a new inventory, opts="border"]
