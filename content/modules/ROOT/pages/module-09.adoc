...
image::wf-template-example-list.png[Workflow Job Templates list view, opts="border"]
...
. **Add the first step.**
+
**Click** the **Add step** button to add the first node.
...
+
**Hover** over the `apache101` node, **click** the kebab menu, and select **Add step and link**.
